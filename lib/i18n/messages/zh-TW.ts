...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.label": "終端機",
    "terminal.clear": "清屏",
    "terminal.resize": "拖曳調整高度。按兩下即可占滿底部",
    "terminal.noCwd": "無可用工作目錄",
    "tools.label": "工具",
    "tools.title": "工具定義",
    ...
    "layout.resizeChatColumn": "調整聊天區域寬度",
    ...
    "files.mention": "提及",
    "files.copyRelativePath": "複製相對路徑",
    "files.copiedRelativePath": "已複製",
    "files.delete": "刪除",
    "files.deleteFileConfirm": "確定刪除檔案「{name}」？此操作無法復原。",
    "files.deleteDirConfirm": "確定刪除資料夾「{name}」及其全部內容？此操作無法復原。",
    "files.deleteFailed": "刪除失敗",
    "files.skillWriteback": "回寫 skill",
    "files.skillWritebackNeedParent": "請在平台聊天頁操作回寫 skill。",
    "files.materialWriteback": "回寫資料",
    "files.materialWritebackNeedParent": "請在平台聊天頁操作回寫資料。",
    "files.systemPromptWriteback": "回寫系統提示詞",
    "files.systemPromptWritebackNeedParent": "請在平台聊天頁操作回寫系統提示詞。",
    "files.download": "下載檔案",
