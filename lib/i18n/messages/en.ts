...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.resize": "Drag to resize. Double-click to fill to the bottom",
    "terminal.noCwd": "No cwd",
    ...
    "layout.resizeChatColumn": "Resize chat column",
    ...
    "files.copiedRelativePath": "Copied",
    "files.delete": "Delete",
    "files.deleteFileConfirm": "Delete file \"{name}\"? This cannot be undone.",
    "files.deleteDirConfirm": "Delete folder \"{name}\" and everything inside it? This cannot be undone.",
