...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.label": "终端",
    "terminal.clear": "清屏",
    "terminal.resize": "拖拽调整高度。双击恢复占满底部",
    "terminal.noCwd": "无可用工作目录",
    "session.info": "会话信息",
    "session.name": "名称",
    "session.file": "文件",
    ...
    "layout.resizeChatColumn": "调整聊天区域宽度",
    ...
    "files.copiedRelativePath": "已复制",
    "files.delete": "删除",
    "files.deleteFileConfirm": "确定删除文件「{name}」？此操作不可恢复。",
    "files.deleteDirConfirm": "确定删除文件夹「{name}」及其全部内容？此操作不可恢复。",
