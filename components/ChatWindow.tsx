...
// xterm is browser-only (references `self`); load it lazily on the client.
...
interface Props {
  ...
  /** Show the PTY terminal panel below the chat input. */
